...
```text
classes.xsl              47938  33.75%
to-java.xsl              43656  30.73%
set-locators.xsl         14360  10.11%
set-original-names.xsl   9508   6.69%
attrs.xsl                6086   4.28%
package.xsl              5335   3.76%
anonymous-to-nested.xsl  5221   3.68%
data.xsl                 5109   3.60%
tests.xsl                4838   3.41%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-06-26 at 18:41,
on Linux with 4 CPUs.
The total is 142051 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/28257959038
